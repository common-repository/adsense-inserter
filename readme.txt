...
1. Upload `adsense-inserter` to the `/wp-content/plugins/` directory
1. Activate the plugin through the 'Plugins' menu in WordPress
1. Click **Adsense Inserter** on the admin menu to enable and set your options.
...
= Will wpautop mess up my Adsense code? =
No.  No, Adsense Inserter avoids the problems associated with wpautop.

= How many Adsense ads can I store with Adsense Inserter? =
You can store an unlimited amount of Adsense ads with Adsense Inserter.
...
No, Adsense Inserter does not auto select ad sizes.

= Can I add Adsense ads into my header? =
Yes, you can add Adsense ads into your header.

== Screenshots ==

[See screenshots at thinklandingpages.com] (http://www.thinklandingpages.com/adsense-inserter-quick-start-guide/)
